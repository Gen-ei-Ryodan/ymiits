                    ...
                    @forelse($items as $index => $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin.pengurus.edit', $item) }}" class="btn btn-sm btn-primary">
                                ...
                                <form id="delete-form-{{ $item->id }}" action="{{ route('admin.pengurus.destroy', $item) }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
