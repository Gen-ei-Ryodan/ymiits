    ...
    <form action="{{ route('admin.testimoni.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="urutan" id="urutan" class="form-control @error('urutan') is-invalid @enderror" value="{{ old('urutan') }}" required>
                        @error('urutan')
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_pemberi" id="nama_pemberi" class="form-control @error('nama_pemberi') is-invalid @enderror" value="{{ old('nama_pemberi') }}" required>
                @error('nama_pemberi')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
