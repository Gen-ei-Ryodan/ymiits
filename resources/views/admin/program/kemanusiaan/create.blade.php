<!-- resources/views/admin/program/kemanusiaan/create.blade.php -->
@extends('layouts.app')

@section('title', 'Tambah Program Kemanusiaan')

@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div class="card-title">Tambah Program Kemanusiaan</div>
            <a href="{{ route('admin.kemanusiaan.index') }}" class="btn btn-primary">
                <i class="fas fa-arrow-left"></i> Kembali
            </a>
        </div>
        <form action="{{ route('admin.kemanusiaan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                @if ($errors->any())
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        @enderror
                        <small class="form-text text-muted">Deskripsi ini akan ditampilkan pada halaman program kemanusiaan di
                            website.</small>
                    </div>
                </div>
