        ...
        <div class="col-md-12 px-3">
            <div class="d-flex align-items-center justify-content-between">
                <h3 class="mb-0 text-dark">
                    <i class="fas fa-hands-helping me-2 text-primary"></i>Program Kemanusiaan
                </h3>
                @if (!$programKemanusiaan)
                    <a href="{{ route('admin.kemanusiaan.create') }}" class="btn btn-success">
        ...
        <div class="col-md-12 px-3">
            <div class="card mb-4">
                <div class="card-header bg-primary text-white py-3 d-flex justify-content-between align-items-center">
                    ...
                    @if ($programKemanusiaan)
                        <a href="{{ route('admin.kemanusiaan.edit', $programKemanusiaan->id) }}" class="btn btn-light btn-sm">
                ...
                <div class="card-body p-4">
                    @if ($programKemanusiaan)
                        <div class="bg-light p-4 rounded border">
                            <p class="mb-0">{{ $programKemanusiaan->deskripsi }}</p>
                        </div>
                    @else
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('admin.kemanusiaan.create') }}" class="btn btn-primary">
                ...
                <div class="card border-primary">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('admin.sub-program-kemanusiaan.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="program_kemanusiaan_id" value="{{ $programKemanusiaan->id }}">
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card h-100 mx-3">
                            ...
                            <div class="card-body p-0">
                                @if ($sub->foto)
                                    <div class="text-center p-3">
                                        <img src="{{ asset('storage/program/kemanusiaan/sub/' . $sub->foto) }}"
                            ...
                            <div class="card-footer bg-transparent d-flex justify-content-end p-3">
                                <form action="{{ route('admin.sub-program-kemanusiaan.destroy', $sub->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
