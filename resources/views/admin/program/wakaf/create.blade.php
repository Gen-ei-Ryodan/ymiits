<!-- resources/views/admin/program/wakaf/create.blade.php -->
@extends('layouts.app')

@section('title', 'Tambah Program Wakaf')

@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div class="card-title">Tambah Program Wakaf</div>
            <a href="{{ route('admin.wakaf.index') }}" class="btn btn-primary">
                <i class="fas fa-arrow-left"></i> Kembali
            </a>
        </div>
        <form action="{{ route('admin.wakaf.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                @if ($errors->any())
