...
<div class="container-fluid p-4">
        ...
        <div class="col-md-12 px-3">
            <div class="d-flex align-items-center justify-content-between">
                <h3 class="mb-0 text-dark">
                    <i class="fas fa-pray me-2 text-primary"></i>Program Keagamaan
                </h3>
                @if (!$programKeagamaan)
                    <a href="{{ route('admin.keagamaan.create') }}" class="btn btn-success">
        ...
        <div class="col-md-12 px-3">
            <div class="card mb-4">
                <div class="card-header bg-primary text-white py-3 d-flex justify-content-between align-items-center">
                    ...
                    @if ($programKeagamaan)
                        <a href="{{ route('admin.keagamaan.edit', $programKeagamaan->id) }}" class="btn btn-light btn-sm">
                ...
                <div class="card-body p-4">
                    @if ($programKeagamaan)
                        <div class="bg-light p-4 rounded border">
                            <p class="mb-0">{{ $programKeagamaan->deskripsi }}</p>
                        </div>
                    @else
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('admin.keagamaan.create') }}" class="btn btn-primary">
    ...
    @if ($programKeagamaan)
                ...
                <div class="card border-primary">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('admin.sub-program.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="program_keagamaan_id" value="{{ $programKeagamaan->id }}">
        ...
        @if ($programKeagamaan->subPrograms->count() > 0)
            <div class="row">
                @foreach ($programKeagamaan->subPrograms as $sub)
    ...
    <img src="{{ $sub->foto ? asset('storage/program/keagamaan/sub/' . $sub->foto) : asset('images/default.jpg') }}"
        ...
        alt="Foto {{ $sub->judul }}">
                            ...
                            <div class="card-footer bg-transparent d-flex justify-content-end p-3">
                                <form action="{{ route('admin.sub-program.destroy', $sub->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
